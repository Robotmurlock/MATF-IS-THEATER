...
\noindent\textbf{Osnovni tok:}
  \begin{legal}
    \item Organizator pristupa sistemu.
    \item Organizator proverava da li postoji neki problem sa predstavama koje se odr.avaju nedelju dana od dana kada vrši proveru.
