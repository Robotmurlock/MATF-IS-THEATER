...
\begin{figure}[H]
  \begin{center}
      \includegraphics[width=60mm]{../images/dfd0.png}
  \end{center}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Organizacija predstave: dijagram toka podataka}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Rezervacija sale: dijagram toka podataka}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Prodaja karata: dijagram toka podataka}
