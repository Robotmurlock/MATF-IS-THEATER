...
predstave mogu da kupe ili rezervišu kartu za pozorište preko veb stranice pozorišta.
...
\noindent\textbf{Učesnici:} 
  \begin{itemize}
    ...
    \item Prodavac karata koji je zaposlen u pozorištu.
  \end{itemize}
  ...
  \begin{legal}
    ...
    \item Prodavac zahteva račun za kupovinu od sistema.
    \item Sistem prikazuje prodavcu račun za kupovinu.
    \item Prodavac saopštava ukupnu cenu klijentu.
    \item Klijent izvršava plaćanje.
    \item Prodavac potvrđuje uplatu.
    \item Sistem štampa odgovarajuće karte.
    \item Prodavac daje klijentu karte.
  \end{legal}
  ...
  \begin{itemize}
    \item \textbf{A1. Ne postoji dovoljan broj karata za brodaju (korak 1.1.2)} 
        \begin{legal}
          \item Prodavac saopštava klijentu da ne postoji dovoljan broj karata
          \item Proces se nastavlja u \textbf{koraku 1}.
        \end{legal}
    \item \textbf{A2. Kodovi koje je klijent saopštio nisu validni (korak 1.2.2)} 
        \begin{legal}
          \item Prodavac saopštava klijentu da rezervacije nisu važeće.
          \item Proces se nastavlja u \textbf{koraku 1}.
        \end{legal}
    \item \textbf{A3. Klijent ipak ne želi da izvrši plaćanje (korak 5)} 
        \begin{legal}
          \item Prodavac stornira račun.
          \item Proces se nastavlja u \textbf{koraku 1}.
        \end{legal}
  \end{itemize}
  ...
  \begin{itemize}
    \item \textbf{1.1. Klijent nema rezervisane karte}
        \begin{legal}
          \item Prodavac proverava da li ima slobodnih željenih karata tako što unosi upit preko odgovarajućeg interfejsa.
          \item Sistem daje prodavcu informacije o broju slobodnih karata za dati upit.
        \end{legal}
    \item \textbf{1.2. Klijent ima rezervisane karte}
        \begin{legal}
          \item Prodavac zahteva odgovarajuće kodove za rezervisane karte.
          \item Kupac daje prodavcu kodove za rezervisane karte.
          \item Prodavac provera da li su kodovi validni tako što ih unosi u sistem.
