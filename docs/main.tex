...
\noindent\textbf{Osnovni tok:}
  \begin{legal}
    ...
    \item Sistem obaveštava supervizora emailom o prijavljenoj predstavi.
  \end{legal}
...
\noindent\textbf{Osnovni tok:}
  \begin{legal}
    ...
    \item Sistem obaveštava organizatora emailom o odobrenju. 
  \end{legal}
...
\begin{itemize}
  \item \textbf{A1. Predstava je odbijena} 
      \begin{legal}
        ...
        \item Sistem obaveštava organizatora emailom o odbijanju uz obrazloženje. 
      \end{legal}
\end{itemize}
...
\noindent\textbf{Osnovni tok:}
  \begin{legal}
    ...
    \item Sistem obaveštava zaposlenog o kreiranom profilu putem emaila. 
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Sistem obaveštava glumce emailom o sali za održavanje predstave ili probe. 
  \end{legal}
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Sistem ažurira bazu podataka.
    \item Sistem obaveštava glumce emailom o oslobođenom terminu za datu salu
  \end{legal}
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Organizator dodeljuje slobodnu salu datoj predstavi za određeni termin.
     \item Sistem ažurira bazu podataka.
    \item Sistem obaveštava glumce emailom o promeni sale za održavanje predstave ili probe
  \end{legal}
...
\noindent\textbf{Preduslovi:}
  \begin{itemize}
    ...
    \item Organizator je zadužen za barem jednu predstavu.
  \end{itemize}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Vodjenje finansija}
  \label{usecase_vodjenje_finansija}
\end{figure}

\subsubsection{Pregled finansija u odredjenom vremenskom periodu}
\noindent\textbf{Kratak opis:} Supervizor pozorišta može zatražiti pregled finansija
u odredjenom vremenskom periodu. Nakon što dobije prikaz izveštaje ima opciju da izveštaj
otštampa ili sačuva na sistemu.
...
\begin{itemize}
  ...
  \item Štampač za štampanje izveštaja
\end{itemize}
