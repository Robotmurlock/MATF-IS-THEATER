...
\textbf{karta}\{\underline{kod}, cena, tip, \textit{sifra\_predstave}, \textit{broj\_sale}, \textit{datum}, \textit{vreme}, \textit{id\_klijenta}\}\\
...
\textbf{poseduje:} 
\begin{itemize}
  \item \textbf{karta}[sifra\_predstave, broj\_sale, datum, vreme] 
$\subseteq$ \textbf{repertoar}[sifra\_predstave, broj\_sale, datum, vreme]
  \item \textbf{karta}[id\_klijenta] $\subseteq$ \textbf{klijent}[id\_klijenta]
\end{itemize}
