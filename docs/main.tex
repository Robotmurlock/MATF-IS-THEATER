...
Ovaj rad predstavlja informacioni sistem jednog pozorišta . Sistem je namenjen korisnicima koji su zaposleni u pozorištu i klijentima,tj. posetiocima pozorišta. Izraden je kao projekat u okviru predmeta "Informacioni sistemi" na master studijama Matematičkog fakulteta.Vođenje i organizacija rada pozorišta ukljucuje niz aktivnosti. U okviru ovog projekta urađene su sledeće funkcionalnosti:
...
osnovne aktere u sistemu i veze medju njima.
...
Pregled procesa je prikazan na slici \ref{usecase_organizacija_predstave}. Prikaz stanja predstave je predstavljen na slici \ref{state_predstava}. Tok podataka pri organizaciji je prikazan dijagramom na slici \ref{dfd2_organizacija_predstave}. Aktivnosti pri organizaciji predstave prikazane su na kraju poglavlja, dijagramom na slici \ref{da_organizacije_predstave}. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Organizacija predstave: dijagram aktivnosti}
...
\begin{figure}[H]
  \begin{center}
      \includegraphics[width=100mm,height=60mm]{../images/activity_vodjenje_finansija.jpg}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm,height=90mm]{../images/sequence_vodjenje_finansija_1.jpg}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=90mm,height=90mm]{../images/sequence_vodjenje_finansija_2.jpg}
  \end{center}
