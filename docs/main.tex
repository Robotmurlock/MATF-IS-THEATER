...
\end{enumerate}
\subsubsection{Prijavljivanje sale za predstavu ili probu}
...
\begin{itemize}
 \item \textbf{A1. Neuspelo prijavljivanje} 
  ...
  \item \textbf{A7. Sve sale su zauzete za odabrani termin} 
    ...
    \end{legal}
\end{itemize}
\subsubsection{Odjavljivanje sale za predstavu}
...
\subsubsection{Promena sale za održavanje predstave}
...
\noindent\textbf{Postuslovi:} 
  \begin{itemize}
    ...
    \item Repertoar može da pogleda bilo koji korisnik sistema koji ima napravljen korisnilki nalog.
  \end{itemize}
