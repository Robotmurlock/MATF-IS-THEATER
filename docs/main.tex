...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/zaposleni_prijavljivanje.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/zaposleni_prijavljivanje2.png}
  \end{center}
  \caption{Registracija}
  \label{zaposleni_prijavljivanje2}
\end{figure}
\subsubsection{Deo aplikacije namenjen za supervizora}
Supervizor ima uvid u predstave (odobrava ih), repertoar (održavanje), zaposlene (dodaje nove zaposlene u sistem) i u finansije


\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_odobravanje_predstave.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_zaposleni.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_kreiranje_naloga.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_finansije_izvestaj.png}
  \end{center}
  \caption{Finansijski izveštaj za određeni period}
  \label{supervizor_finansije_izvestaj}
\end{figure}\begin{figure}[H]

  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_finansije4.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/supervizor_finansije_izvestaj2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_repertoar1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_repertoar2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_uklanjanje_predstave1.png}
  \end{center}
  \caption{Uklanjanje predstave sa repertoara}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_dodavanje_gostovanja1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_raspored1.png}
  \end{center}
...
Organizator ima pristup svim predstavama za koje je zadužen. Ima mogućnost kreiranja predstave, dodeljivanja sale i broja karata za određenu predstavu

\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_lista_predstava.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_kreiranje_predstave.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_dodeljivanje_sale.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_promena_sale.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_karte.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/organizator_dodela_karata.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/blagajnik.png}
  \end{center}
  \caption{Prikaz koji vidi blagajnik}
  \label{blagajnik}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/blagajnik_prodaja_karata.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/blagajnik_prodaja_karata2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/blagajnik_stampanje_karata.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/blagajnik_povracaj_novca.png}
  \end{center}
...
\subsection{Deo aplikacije namenjen za klijenta}

Da bi klijenti mogli da koriste aplikaciju neophodno je da se prvo prijave, ili da se registruju ukoliko nemaju već napravljen nalog.


\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_registracija.png}
  \end{center}
  \caption{Registracija}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_repertoar1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_repertoar2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_rezervacija1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_kupovina1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=120mm]{../images/ui_klijent_kupovina2.png}
  \end{center}
...
\section{Zaključak}
Ovim projektom smo predstavili neke od slučajeva upotrebe informacionog sistema namenjenog radu pozorišta, a neke od njih i implementirali. 
Prilikom izrade projekta upoznali smo se sa radom pozorišta i pokušali da prilagodimo sistem što je bolje moguće.
Verujemo da bi u budućnosti, uz dobru implementaciju postojećih i dodatnih funkcionalnosti, sistem mogao da se koristi u nekom pozorištu.
