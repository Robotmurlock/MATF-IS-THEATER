...
Organizator predstave u pripremi treba da rezerviše salu za probu ili konkretnu predstavu. Dakle, treba omogućiti uvid u slobodne sale, 
        kao i rezervacije unapred. Ukoliko dođe do promene termina predstave ili probe, potrebno je promeniti i termin za salu. Organizator ima mogućnost promene sale ukoliko je druga sala slobodna za dati termin. 

\begin{figure}[H]
  \begin{center}
      \includegraphics[width=100mm,height=60mm]{../diagrams/usecase_rezervacija_sale.png}
  \end{center}
...
\noindent\textbf{Preduslovi:}
  \begin{itemize}
    \item Određena predstava je evidentirana u sistemu kao ,,u pripremi``.
  \end{itemize}
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Organizator bira predstavu sa statusom ,,u pripremi`` kojoj želi da dodeli salu.
    ...
    \item Sistem obaveštava glumce mejlom o sali za održavanje predstave ili probe. 
  \end{legal}
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Sistem ažurira bazu podataka.
    \item Sistem obaveštava glumce mejlom o oslobođenom terminu za datu salu
  \end{legal}
...
\noindent\textbf{Preduslovi:}
  \begin{itemize}
    \item Predstavi ili probi je dodeljena nova
  \end{itemize}
...
\noindent\textbf{Osnovni tok:}
  ...
  \item Organizator unosi podatke za prijavljivanje na sistem.
    ...
    \item Organizator dodeljuje slobodnu salu datoj predstavi za određeni termin.
     \item Sistem ažurira bazu podataka.
    \item Sistem obaveštava glumce mejlom o promeni sale za održavanje predstave ili probe
  \end{legal}
...
\subsubsection{Registracija i prijavljivanje na stranicu pozorišta}
  \textbf{Napomena:} Registraciju i prijavljivanje je potrebno izdvojiti u poseban slučaj upotrebe.
...
\noindent\textbf{Učesnici:} 
  ...
  \noindent\textbf{Preduslovi:} 
  \begin{itemize}
    \item Klijent mora da ima rezervisanu kartu ili mora biti slobodan broj mesta za tu predstavu.
  \end{itemize}
...
\begin{figure}[H]
  \begin{center}
      \includegraphics[width=100mm,height=60mm]{../diagrams/usecase_vodjenje_finansija.jpg}
  \end{center}
